            ...
            <Row className="mt-4">
                <Col md={4} style={{ marginLeft: "auto" }}>
                    <Card className="mb-4 shadow-lg">
                        ...
                        <Card.Body>
                            <Card.Title className="text-center fs-4 fw-semibold mb-4 mt-4">
                    ...
                    <Card className="mb-4 shadow-lg">
                        <Card.Body>
                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>
                                    <i className="bi bi-flag text-muted me-2" /> 🇪🇸 Spagnolo – <strong>A1</strong> (base)
                                </ListGroup.Item>
                                <ListGroup.Item>
                    ...
                    <Card className="mb-4 shadow-lg">
                        <Card.Body>
                            ...
                            <ListGroup variant="flush">
                                <ListGroup.Item>
                                    <strong>Ruolo:</strong> Tutor per studenti diversamente abili e neuro diversi<br />
                                    <strong>Ente:</strong> Università degli Studi di Palermo<br />
                ...
                <Col md={5} style={{ marginRight: "auto" }}>
                    ...
                    <Card className="mb-4 shadow-lg">
                        ...
                        <Card.Body>
                            <Card.Title className='fw-semibold' >Perché Sei Finito In Questa Pagina</Card.Title>
                            <Card.Text>
